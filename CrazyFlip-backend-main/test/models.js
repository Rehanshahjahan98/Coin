...
describe('User Model', () => {
  it('should create a new user', (done) => {
    const UserMock = sinon.mock(new User({ email: 'test@gmail.com', walletAddress: "0xF1d3217f5D8368248E9AfBAd25e5396b5a93599b", password: 'root' }));
  ...
  it('should return error if user is not created', (done) => {
    const UserMock = sinon.mock(new User({ email: 'test@gmail.com', walletAddress: "0xy1d3217f5D8368248E9AfBAd25e5396b5a93599b", password: 'root' }));
    const user = UserMock.object;
    const expectedError = {
  ...
  it('should find user by email', (done) => {
    ...
    const expectedUser = {
      ...
      walletAddress: "0xF1d3217f5D8368248E9AfBAd25e5396b5a93599b",
    };

    userMock
      .expects('findOne')
      .withArgs({ walletAddress: "0xF1d3217f5D8368248E9AfBAd25e5396b5a93599b" })
      .yields(null, expectedUser);

    User.findOne({ walletAddress: "0xF1d3217f5D8368248E9AfBAd25e5396b5a93599b" }, (err, result) => {
      userMock.verify();
      userMock.restore();
  ...
  it('should remove user by email', (done) => {
    ...
    User.remove({ walletAddress: "0xF1d3217f5D8368248E9AfBAd25e5396b5a93599b" }, (err, result) => {
      userMock.verify();
      userMock.restore();
      expect(err).to.be.null;
  ...
  it('should generate gravatar with email', () => {
    const UserMock = sinon.mock(new User({ walletAddress: "0xF1d3217f5D8368248E9AfBAd25e5396b5a93599b" }));
    const user = UserMock.object;
